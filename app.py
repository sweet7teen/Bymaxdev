...
token_lock = threading.Lock()  # Lock untuk mencegah race condition

def refresh_token():
    global token_cache
    refresh_url = "http://172.24.52.4:7171/api/refreshtoken"
...
def get_token():
    ...
    def is_token_expired(token, margin=600):  # Tambahkan margin 5 menit
        try:
